...
class UserSingleNoExpire extends IModel {
  static String _delimiter = ':';

  static const String _name = 'UserSingleNoExpire';

  static const List _pk = const [0,1];
  static const List _pkColumns = const ["id","name"];
  ...
  UserSingleNoExpire([List args = null]) : super() {
    if (args == null) {
