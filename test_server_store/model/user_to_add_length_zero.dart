...
class UserToAddLengthZero extends IModel {
  static String _delimiter = ':';

  static const String _name = 'UserToAddLengthZero';

  static const List _pk = const [0];
  static const List _pkColumns = const ["id"];
  static const num _length = 2;
  static const List _columns = const [const {"i":0,"full":"id","abb":"i","toAdd":true,"toSet":false,"toAbb":false,"toFull":false,"toList":false},const {"i":1,"full":"name","abb":"n","toAdd":true,"toSet":false,"toAbb":false,"toFull":false,"toList":false},];
  ...
  UserToAddLengthZero([List args = null]) : super() {
    if (args == null) {
