...
class UserToSetLengthZero extends IModel {
  static String _delimiter = ':';

  static const String _name = 'UserToSetLengthZero';

  static const List _pk = const [0];
  static const List _pkColumns = const ["id"];
  static const num _length = 2;
  static const List _columns = const [const {"i":0,"full":"id","abb":"i","toAdd":false,"toSet":true,"toAbb":false,"toFull":false,"toList":false},const {"i":1,"full":"name","abb":"n","toAdd":false,"toSet":true,"toAbb":false,"toFull":false,"toList":false},];
  static const Map _mapAbb = const {"i":0,"n":1};
  static const Map _mapFull = const {"id":0,"name":1};

  List _args;
  List<bool> _updatedList;
  bool _exist = false;

  UserToSetLengthZero([List args = null]) : super() {
    if (args == null) {
