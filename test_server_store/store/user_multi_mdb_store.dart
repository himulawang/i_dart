...
class UserMultiMariaDBStore extends IMariaDBStore {
  ...
  static Future add(UserMulti model) {
    if (model is! UserMulti) throw new IStoreException(21023, [model.runtimeType, _modelName]);
    ...
    return handler.prepareExecute(IMariaDBSQLPrepare.makeAdd(table, UserMulti._mapFull, UserMulti._columns), toAddList)
  ...
  static Future set(UserMulti model) {
    if (model is! UserMulti) throw new IStoreException(21026, [model.runtimeType, _modelName]);
  ...
  static Future del(model) {
    if (model is! UserMulti) throw new IStoreException(21034, [model.runtimeType, _modelName]);
