...
class UserPKMariaDBStore extends IMariaDBStore {
  static const _key = 'u-pk';
  static const _table = 'PK';
  static const Map store = const {"type":"mariaDB","readWriteSeparate":false,"shardMethod":"NONE","master":"SingleDB","slave":"SingleDBSlave","abb":"u","table":"PK"};
  static const _modelName = 'UserPK';

  static Future set(UserPK pk) {
    if (pk is! UserPK) throw new IStoreException(21036, [pk.runtimeType, _modelName]);
    if (!pk.isUpdated()) {
