...
class UserToAddLengthZeroMariaDBStore extends IMariaDBStore {
  static const Map store = const {"type":"mariaDB","readWriteSeparate":false,"sharding":true,"shardMethod":"CRC32","master":"GameDB","slave":"GameDBSlave","table":"UserToAddLengthZero"};
  static const String table = 'UserToAddLengthZero';
  static const String _modelName = 'UserToAddLengthZero';

  static Future add(UserToAddLengthZero model) {
    if (model is! UserToAddLengthZero) throw new IStoreException(21023, [model.runtimeType, _modelName]);
    ...
    return handler.prepareExecute(IMariaDBSQLPrepare.makeAdd(table, UserToAddLengthZero._mapFull, UserToAddLengthZero._columns), toAddList)
  ...
  static Future set(UserToAddLengthZero model) {
    if (model is! UserToAddLengthZero) throw new IStoreException(21026, [model.runtimeType, _modelName]);
  ...
  static Future del(model) {
    if (model is! UserToAddLengthZero) throw new IStoreException(21034, [model.runtimeType, _modelName]);
