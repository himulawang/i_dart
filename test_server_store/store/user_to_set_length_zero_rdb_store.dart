...
class UserToSetLengthZeroRedisStore extends IRedisStore {
  static const String abb = 'utslz';
  static const Map store = const {"type":"redis","readWriteSeparate":false,"sharding":true,"shardMethod":"CRC32","master":"GameCache","slave":"GameCacheSlave","expire":86400,"mode":"Atom","abb":"utslz"};
  static const num expire = 86400;
  static const String _modelName = 'UserToSetLengthZero';

  static Future add(UserToSetLengthZero model) {
    if (model is! UserToSetLengthZero) throw new IStoreException(20022, [model.runtimeType, _modelName]);
  ...
  static Future set(UserToSetLengthZero model) {
    if (model is! UserToSetLengthZero) throw new IStoreException(20026, [model.runtimeType, _modelName]);
  ...
  static Future get(id) {
    UserToSetLengthZero model = new UserToSetLengthZero()..setPK(id);
  ...
  static Future del(UserToSetLengthZero model) {
    if (model is! UserToSetLengthZero) throw new IStoreException(20030, [model.runtimeType, _modelName]);
  ...
  static String _makeKey(UserToSetLengthZero model) {
    var pk = model.getPK();
    if (pk is List) {
      if (pk.contains(null)) throw new IStoreException(20042, ['UserToSetLengthZero']);
      return '${abb}:${pk.join(':')}';
    } else {
      if (pk == null) throw new IStoreException(20042, ['UserToSetLengthZero}']);
      return '${abb}:${pk}';
    }
  }
