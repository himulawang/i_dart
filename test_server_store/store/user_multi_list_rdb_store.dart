...
class UserMultiListRedisStore extends IRedisStore {
  ...
  static Future<UserMultiList> set(UserMultiList list) {
    if (list is! UserMultiList) throw new IStoreException(20040, [list.runtimeType, _listName]);
  ...
  static Future del(UserMultiList list) {
    if (list is! UserMultiList) throw new IStoreException(20038, [list.runtimeType, _listName]);
