...
class UserForeverMariaDBStore extends IMariaDBStore {
  static const Map store = const {"type":"mariaDB","readWriteSeparate":false,"sharding":true,"shardMethod":"CRC32","master":"GameDB","slave":"GameDBSlave","table":"UserForever"};
  static const String table = 'UserForever';
  static const String _modelName = 'UserForever';

  static Future add(UserForever model) {
    if (model is! UserForever) throw new IStoreException(21023, [model.runtimeType, _modelName]);
    ...
    return handler.prepareExecute(IMariaDBSQLPrepare.makeAdd(table, UserForever._mapFull, UserForever._columns), toAddList)
  ...
  static Future set(UserForever model) {
    if (model is! UserForever) throw new IStoreException(21026, [model.runtimeType, _modelName]);
  ...
  static Future del(model) {
    if (model is! UserForever) throw new IStoreException(21034, [model.runtimeType, _modelName]);
