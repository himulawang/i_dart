...
class UserToSetLengthZeroMariaDBStore extends IMariaDBStore {
  static const Map store = const {"type":"mariaDB","readWriteSeparate":false,"sharding":true,"shardMethod":"CRC32","master":"GameDB","slave":"GameDBSlave","table":"UserToSetLengthZero"};
  static const String table = 'UserToSetLengthZero';
  static const String _modelName = 'UserToSetLengthZero';

  static Future add(UserToSetLengthZero model) {
    if (model is! UserToSetLengthZero) throw new IStoreException(21023, [model.runtimeType, _modelName]);
    ...
    return handler.prepareExecute(IMariaDBSQLPrepare.makeAdd(table, UserToSetLengthZero._mapFull, UserToSetLengthZero._columns), toAddList)
  ...
  static Future set(UserToSetLengthZero model) {
    if (model is! UserToSetLengthZero) throw new IStoreException(21026, [model.runtimeType, _modelName]);
  ...
  static Future del(model) {
    if (model is! UserToSetLengthZero) throw new IStoreException(21034, [model.runtimeType, _modelName]);
