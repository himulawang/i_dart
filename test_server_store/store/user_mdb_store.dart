...
class UserMariaDBStore extends IMariaDBStore {
  static const Map store = const {"type":"mariaDB","readWriteSeparate":false,"sharding":true,"shardMethod":"CRC32","master":"GameDB","slave":"GameDBSlave","table":"User"};
  static const String table = 'User';
  static const String _modelName = 'User';

  static Future add(User model) {
    if (model is! User) throw new IStoreException(21023, [model.runtimeType, _modelName]);
    ...
    return handler.prepareExecute(IMariaDBSQLPrepare.makeAdd(table, User._mapFull, User._columns), toAddList)
  ...
  static Future set(User model) {
    if (model is! User) throw new IStoreException(21026, [model.runtimeType, _modelName]);
  ...
  static Future del(model) {
    if (model is! User) throw new IStoreException(21034, [model.runtimeType, _modelName]);
