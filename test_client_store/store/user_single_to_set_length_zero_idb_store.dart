...
class UserSingleToSetLengthZeroIndexedDBStore extends IIndexedDBStore {
  static const Map store = const {"type":"indexedDB","master":"GameIDB","objectStore":"UserSingleToSetLengthZero"};
  static const String _modelName = 'UserSingleToSetLengthZero';

  static Future add(UserSingleToSetLengthZero model) {
    if (model is! UserSingleToSetLengthZero) throw new IStoreException(30004, [model.runtimeType, _modelName]);
  ...
  static Future set(UserSingleToSetLengthZero model) {
    if (model is! UserSingleToSetLengthZero) throw new IStoreException(30008, [model.runtimeType, _modelName]);
    ...
    Map toSetAbb = {};
    UserSingleToSetLengthZero._mapAbb.forEach((abb, i) {
      if (UserSingleToSetLengthZero._columns[i]['toSet']) return;
  ...
  static Future get(id) {
    UserSingleToSetLengthZero model = new UserSingleToSetLengthZero()..setPK(id);
  ...
  static Future del(UserSingleToSetLengthZero model) {
    if (model is! UserSingleToSetLengthZero) throw new IStoreException(30010, [model.runtimeType, _modelName]);
  ...
  static _makeKey(UserSingleToSetLengthZero model) {
    var pk = model.getPK();
    if (pk is List) {
