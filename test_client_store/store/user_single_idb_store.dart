...
class UserSingleIndexedDBStore extends IIndexedDBStore {
  ...
  static Future add(UserSingle model) {
    if (model is! UserSingle) throw new IStoreException(30004, [model.runtimeType, _modelName]);
  ...
  static Future set(UserSingle model) {
    if (model is! UserSingle) throw new IStoreException(30008, [model.runtimeType, _modelName]);
  ...
  static Future del(UserSingle model) {
    if (model is! UserSingle) throw new IStoreException(30010, [model.runtimeType, _modelName]);
