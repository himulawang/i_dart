...
class UserSingleToSetLengthZero extends IModel {
  static String _delimiter = ':';

  static const String _name = 'UserSingleToSetLengthZero';

  static const List _pk = const [0];
  static const List _pkColumns = const ["id"];
  static const num _length = 4;
  static const List _columns = const [const {"i":0,"full":"id","abb":"i","toAdd":false,"toSet":true,"toAbb":false,"toFull":false,"toList":false},const {"i":1,"full":"name","abb":"n","toAdd":false,"toSet":true,"toAbb":false,"toFull":false,"toList":false},const {"i":2,"full":"userName","abb":"un","toAdd":false,"toSet":true,"toAbb":false,"toFull":false,"toList":false},const {"i":3,"full":"uniqueName","abb":"un1","toAdd":false,"toSet":true,"toAbb":false,"toFull":false,"toList":false},];
  ...
  UserSingleToSetLengthZero([List args = null]) : super() {
    if (args == null) {
